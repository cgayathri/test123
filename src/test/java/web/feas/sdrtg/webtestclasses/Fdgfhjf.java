package web.feas.sdrtg.webtestclasses;
...
import web.feas.sdrtg.webpageclasses.Sdf;
...
public class Fdgfhjf extends BaseClass {
	...
	public Fdgfhjf() throws Exception {
		PropertyConfigurator.configure("log4j.properties");
		logger = Logger.getLogger(Fdgfhjf.class);
		configFileObj = new ConfigFilesUtility();
		configFileObj.loadPropertyFile("fdgfhjf.properties");
	}
	...
	public void browserName(String browser) throws Exception {
		browserName = browser;
		reports = ExtentConfigurations.getExtentInstance(reportsPath, projectPath, Sdf.projectName);
		test = reports.startTest(setTestcaseName(browserName, "Fdgfhjf"));
	}

	
	public void setUP() throws Exception {
		String primaryInfo = Sdf.primaryInfo;
	...
	public void SdfTest(int i) throws Exception {

	 try{
		Constants.TOTAL_TC = Constants.TOTAL_TC + 1;
		Constants.IS_TESTCASE = true; Constants.iS_WEB = true;
		int datasetScreencount = 1;
		Sdf objSdf = PageFactory.initElements(driver, Sdf.class);
		testLogHeader(test, "Verify Sdf page");
		String text1 = objSdf.clkaContact_404684();
	...
	public void screensTest() throws Exception {
		for(int datasets = 1; datasets <= Sdf.datasetsLength; datasets++) {
			isElementDispalyed = true;			
			setUP();
			if(isElementDispalyed) { SdfTest(datasets);}
			tearDown();
		}	}
